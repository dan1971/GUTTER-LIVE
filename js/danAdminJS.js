	   ...
	   $.ajax({
        url: "db-display-data.php",
            ...
            success: function(data) {
                ...
                colHeadDiv.append('<div class="response-field-cell">Name: ' + Object.keys(data[0][0]) + '</div>');
                colHeadDiv.append('<div class="response-field-cell">Name: ' + Object.keys(data[0][1]) + '</div>');
                colHeadDiv.append('<div class="response-field-cell">Name: ' + Object.keys(data[0][2]) + '</div>');
                colHeadDiv.append('<div class="response-field-cell">Name: ' + Object.keys(data[0][3]) + '</div>');
                colHeadDiv.append('<div class="response-field-cell">Name: ' + Object.keys(data[0][4]) + '</div>');
                colHeadDiv.append('<div class="response-field-cell">Name: ' + Object.keys(data[0][5]) + '</div>');
